...
namespace Compass.CommomLibrary.SistemaDat {
    public class SistemaDat : BaseDocument {
        ...
        public DefBlock Deficit { get { return (DefBlock)Blocos["Deficit"]; } }
        public IntBlock Intercambio { get { return (IntBlock)Blocos["Intercambio"]; } }
        public MerBlock Mercado { get { return (MerBlock)Blocos["Mercado"]; } }
        public PeqBlock Pequenas { get { return (PeqBlock)Blocos["Pequenas"]; } }
                ...
                switch (line.Trim()) {
                    ...
                    default:
                        if (line.Trim().StartsWith("XXX")) {
                            blockStarted = true;
                            continue;
                        } else if (!blockStarted || line.Trim().StartsWith("999")) {
                            blockStarted = false;
                            continue;
                        }
                        break;
        ...
        public int NumeroPatamares {
            get {
                return ((PatBlock)blocos["Patamares"])[0][0];
            }
        }
    }
}
